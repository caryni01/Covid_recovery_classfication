...
library(kernlab)
=======
>>>>>>> 568f685c86d03078e1fe60b01f6142eeb2eccf3f
...
<<<<<<< HEAD
### The performance of selected model
```{r}
...
pdp::partial(gbmA_model, pred.var = c("SBP","LDL"),
             chull = TRUE,
             grid.resolution = 10) %>% 
  autoplot(train = predictors_train_new, rug = TRUE,legend.title = "Probability in Logit",
